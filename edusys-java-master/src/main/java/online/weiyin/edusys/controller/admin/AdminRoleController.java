...
public class AdminRoleController {
    ...
    @Operation(summary = "查询所有角色列表", description = "[admin.role.show]分页查询全部角色信息，一页10条")
    ...
    @Operation(summary = "添加角色", description = "[admin.role.add]添加一个新角色")
...
//        执行
    ...
    @Operation(summary = "根据条件模糊查找角色", description = "[admin.role.show]分页查询条件匹配的角色，一页10条")
    ...
    @Operation(summary = "删除角色", description = "[admin.role.remove]根据角色唯一id删除一个角色")
    @ApiResponse(responseCode = "data", description = "无")
    ...
    @Operation(summary = "修改角色", description = "[admin.role.update]根据角色唯一id修改一个角色的名称")
    @ApiResponse(responseCode = "data", description = "无")
