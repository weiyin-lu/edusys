...
@RestController
@SaCheckLogin
@RequestMapping("/api/admins/menus")
public class AdminMenuController {

    @Autowired
    MenuService menuService;

    @Operation(summary = "查询所有菜单列表", description = "[admin.menu.show]分页查询全部菜单信息，一页10条")
    ...
    @Operation(summary = "根据条件模糊查找菜单", description = "[admin.menu.show]分页查询条件匹配的菜单，一页10条")
    ...
    @Operation(summary = "配置新菜单", description = "[admin.menu.add]配置一个新菜单的信息")
...
//        执行
    ...
    @Operation(summary = "删除菜单", description = "[admin.menu.remove]根据菜单唯一id移除一个菜单")
    @ApiResponse(responseCode = "data", description = "无")
    ...
    @Operation(summary = "修改菜单", description = "[admin.menu.update]根据菜单唯一id修改一个菜单的信息")
    @ApiResponse(responseCode = "data", description = "无")
